...
var addService = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var service, connection, _yield$connection$que3, _yield$connection$que4, result;
  ...
  return function addService(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var updateService = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, _req$body, name_service, price_service, minutes_service, event_color, service, connection, _yield$connection$que5, _yield$connection$que6, result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          id = req.params.id;
          _req$body = req.body, name_service = _req$body.name_service, price_service = _req$body.price_service, minutes_service = _req$body.minutes_service, event_color = _req$body.event_color;
          if (id === undefined || name_service === undefined || price_service === undefined || minutes_service === undefined || event_color === undefined) {
            res.json({
              rta: -1,
        ...
        case 7:
          ...
          _context3.next = 10;
          return connection.query("UPDATE ".concat(table, "  SET ? where id= ?"), [service, id]);
        case 10:
  ...
  return function updateService(_x5, _x6) {
...
var servicesController = exports.servicesController = {
