...
var addClient = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var client, connection, _yield$connection$que3, _yield$connection$que4, rows, _yield$connection$que5, _yield$connection$que6, rowsByEmail, _yield$connection$que7, _yield$connection$que8, rowsByTelefono, _yield$connection$que9, _yield$connection$que10, result;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 4:
          ...
          _context2.next = 8;
          return connection.query("SELECT * FROM ".concat(table, " WHERE dni = ?"), [client.dni]);
        case 8:
        ...
        case 14:
          _context2.next = 16;
          return connection.query("SELECT * FROM ".concat(table, " WHERE email = ?"), [client.email]);
        case 16:
          _yield$connection$que5 = _context2.sent;
          _yield$connection$que6 = _slicedToArray(_yield$connection$que5, 1);
          rowsByEmail = _yield$connection$que6[0];
        ...
        case 22:
          _context2.next = 24;
          return connection.query("SELECT * FROM ".concat(table, " WHERE telefono = ?"), [client.telefono]);
        case 24:
          _yield$connection$que7 = _context2.sent;
          _yield$connection$que8 = _slicedToArray(_yield$connection$que7, 1);
          rowsByTelefono = _yield$connection$que8[0];
  ...
  return function addClient(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
var updateClient = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var id, _req$body, firstName, lastName, email, telefono, dni, client, connection, _yield$connection$que11, _yield$connection$que12, result;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          id = req.params.id;
          _req$body = req.body, firstName = _req$body.firstName, lastName = _req$body.lastName, email = _req$body.email, telefono = _req$body.telefono, dni = _req$body.dni;
          if (id === undefined || firstName === undefined || lastName === undefined || email === undefined || telefono === undefined) {
            res.status(400).json({
        ...
        case 7:
          ...
          _context3.next = 10;
          return connection.query("UPDATE ".concat(table, "  SET ? where id= ?"), [client, id]);
        case 10:
  ...
  return function updateClient(_x5, _x6) {
...
var deleteClient = /*#__PURE__*/function () {
  ...
  return function deleteClient(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var fetchClientData = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var dni, connection, _yield$connection$que15, _yield$connection$que16, result;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 5:
          ...
          _context5.next = 8;
          return connection.query("select * from ".concat(table, " where dni=").concat(dni));
        case 8:
  ...
  return function fetchClientData(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
}();
var clientsController = exports.clientsController = {
