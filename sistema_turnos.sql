...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-05-2024 a las 21:02:42
...
INSERT INTO `barberos` (`id`, `firstName`, `lastName`, `email`, `telefono`, `imagen`, `is_active`, `is_admin`, `fecha_creacion`) VALUES
(46, 'franco', 'beratz', 'francoberatz.fb@gmail.com', '02923421134', 'uploads/imageBarbers/profile.png', 0, 1, '2024-05-16'),
(47, 'franco', 'beratz', 'francoberatz.fb@gmail.com', '02923421134', 'uploads/imageBarbers/profile.png', 1, 1, '2024-05-16');
...
(107, '2024-05-16', '2024-05-16', '2024-05-16 08:00:00', '2024-05-16 09:00:00', 1, 47, 1, '$500.00'),
...
INSERT INTO `usuarios_sistema` (`id`, `firstName`, `lastName`, `email`, `password`, `is_barber`, `is_admin`, `fecha_creacion`, `id_barbero`, `url_image`) VALUES
(31, 'franco', 'beratz', 'francoberatz.fb@gmail.com', '$2b$10$yBJbo4SanTSJFsjBmVQjvegmqQYvNqkdP2EKxolYt8YEcoyMDx.Gm', 0, 1, '2024-05-16 13:58:30', 46, 'uploads/profile.png');
...
--
ALTER TABLE `clientes`
  MODIFY `id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2203;
